# -*- coding: utf-8 -*-
"""
Created on Fri Jul 26 15:17:36 2024

@author: EMmanuel J Perez
"""

# Mod 2 - How to create a cryptocurrency
...
class Blockchain:  #the class Blockchain is created 
    ...
    def __init__(self): #the constructor must be created
        self.chain = []
        self.transactions = [] #this list acts as a mempool
        self.create_block(proof = 1, previous_hash = '0') #the genesis block must be initialized
        self.nodes = set() #the nodes are stored in this collection without order 
    ...
    def create_block(self, proof, previous_hash):
        ...
        #the transactions added to the block are erased from the mempool
        self.transactions = []
    ...
    def proof_of_work(self, previous_proof):
        ...
        while check_proof is False:
            ...
            hash_operation = hashlib.sha256(str(new_proof**2 - previous_proof**2 + (new_proof**3)*(previous_proof**3)).encode()).hexdigest()
    ...
    def add_transaction(self, sender, receiver, amount):
        ...
        #return the index of the block that will recibe this transaction
        previous_block = self.get_previous_block()
        return previous_block['index'] + 1
    
    def add_node(self, address):
        #the url must be processed
        parsed_url = urlparse(address)
        #the node netloc is added to the nodes collection
        ...
        for node in network:
            ...
            if response.status_code == 200:
                ...
                if length > max_length and self.is_chain_valid(chain):
                    max_length = length
                    longest_chain = chain 
        if longest_chain: #if longest chain is different of None
